...
public class EmployeeController {
  ...
  public ResponseEntity<EmployeeModel> addEmployee(@RequestBody EmployeeModel employeeModel){
    EmployeeDTO employeeDTO=new EmployeeDTO(employeeModel.id,employeeModel.firstName, 
          employeeModel.lastName,employeeModel.email,employeeModel.phone,employeeModel.status,
                   employeeModel.posId,employeeModel.posTitle,employeeModel.posStatus);
  ...
  public ResponseEntity<Void> changeEmployeeStatus(@PathVariable Integer empId){
