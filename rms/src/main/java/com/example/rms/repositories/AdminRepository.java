...
public interface AdminRepository extends CrudRepository<Admin,Integer>{
  ...
  @Query(value="select * from admins_ where "
                                 +"username_=:USERNAME "
                                 +"and password_=:PASSWORD",nativeQuery=true)
  public Admin checkLogin(@Param("USERNAME") String username,
                          @Param("PASSWORD") String password);

  @Query("select new com.example.rms.dtos.AdminDashboardDTO("
